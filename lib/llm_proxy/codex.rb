  ...
  module Codex
    ...
    class << self
      ...
      def install_config(slug, port)
        ...
        puts "Added LLM Proxy as an optional provider in #{CODEX_CONFIG}."
        puts "Codex keeps its native ChatGPT models and sign-in."
        puts "Select 'LLM Proxy' from the picker to use proxy models."
      end
